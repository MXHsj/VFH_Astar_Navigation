function []=gridmap2(map,resolution)
% Version: 0.2

global laserScan pose ranges
...
% setOccupancy(map,[(scan_x_global*resolution)' (scan_y_global*resolution)'],0.7);
updateOccupancy(map,[(scan_x_global*resolution)' (scan_y_global*resolution)'],0.8);
